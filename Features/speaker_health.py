...
def speaker_health_test():
    ...
    jarvis_speak("Playing frequency sweep from 20 Hz to 20,000 Hz...")
    ...
    if health_score == 100:
        jarvis_speak("The speaker is in excellent condition!")
    elif 80 <= health_score < 100:
        jarvis_speak("The speaker is in good condition.")
    elif 60 <= health_score < 80:
        jarvis_speak("The speaker is in average condition.")
    else:
        jarvis_speak("The speaker might be in poor condition.")
